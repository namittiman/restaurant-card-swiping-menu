...
- (void)viewDidLoad {
    ...
    r.name = @"Olive Garden";
    r.filename = @"olive_garden";
    r.notes = @"Italian";
    r.rating = 4.7;
    r.categories = [[NSMutableArray alloc] initWithObjects:@"All",@"Entrees",@"Appetizers",@"Soups",@"Drinks",@"Desserts", nil ];
    r.location = @"Walnut St, Cary";
    r.cuisine = @"Italian";
    ...
    r.filename = @"the_cowfish_sushi_burger";
    r.cuisine = @"Burger, Sushi, Fusion";
    r.rating = 3.9;
    r.location = @"North Raleigh";
    ...
    r.name = @"Taste";
    r.filename = @"taste";
    r.cuisine = @"American, Tapas";
    r.rating = 3.8;
    r.location =@"West Raleigh";
    ...
    r = [[Restaurant alloc] init];
    r.name = @"Roast Grill";
    r.filename = @"roast_grill";
    r.cuisine = @"American, Fast Food";
    r.rating = 4.5;
    r.location =@"Inside the Beltline";
    ...
    r = [[Restaurant alloc] init];
    r.name = @"Sushi Iwa";
    r.filename = @"sushi_iwa";
    r.cuisine = @"Asian, Sushi, Thai";
    r.location = @"Apex";
    r.rating = 2.1;
    r.menu_items = [[NSMutableArray alloc] init ];
